...
var _MarkerWithLabelCreator = require('./MarkerWithLabelCreator');

var _MarkerWithLabelCreator2 = _interopRequireDefault(_MarkerWithLabelCreator);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MarkerWithLabel = function (_Component) {
  (0, _inherits3.default)(MarkerWithLabel, _Component);
  ...
  function MarkerWithLabel() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = MarkerWithLabel.__proto__ || (0, _getPrototypeOf2.default)(MarkerWithLabel)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
  ...
  (0, _createClass3.default)(MarkerWithLabel, [{
    ...
    value: function componentWillMount() {
      ...
      var marker = _MarkerWithLabelCreator2.default._createMarker(this.props);
    ...
    value: function render() {
      if (this.state.marker) {
        return _react2.default.createElement(
          _MarkerWithLabelCreator2.default,
...
MarkerWithLabel.propTypes = (0, _extends3.default)({}, _MarkerWithLabelCreator.markerDefaultPropTypes, _MarkerWithLabelCreator.markerControlledPropTypes, _MarkerWithLabelCreator.markerEventPropTypes);
